...
/**
 * Card authorization — delegates to ProjectPolicy (the ownership chokepoint).
 ...
 * BoardPolicy / ColumnPolicy patterns.
 */
final class CardPolicy
{
     ...
     */
    public function reorder(User $user, Card $card): bool
    {
        return $user->can('view', $card->column->board->project);
    }
}
