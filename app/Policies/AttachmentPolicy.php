...
/**
 * Attachment authorization — view / update / delete ALL delegate to
 ...
 *
 * Compared to `CommentPolicy`: comments have an author-vs-author 403 path
...
final class AttachmentPolicy
{
     ...
     */
    public function view(User $user, CardAttachment $attachment): bool
    {
     ...
     */
    public function update(User $user, CardAttachment $attachment): bool
    {
        return $user->can('view', $attachment->card->column->board->project);
    }
     ...
     * attachment exists.
     */
    public function delete(User $user, CardAttachment $attachment): bool
    {
        return $user->can('view', $attachment->card->column->board->project);
    }
}
