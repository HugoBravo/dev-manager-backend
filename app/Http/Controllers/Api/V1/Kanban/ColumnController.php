...
use App\Exceptions\Kanban\ColumnHasContentsException;
...
use App\Http\Requests\Kanban\ReorderColumnsRequest;
 ...
 * position via `App\ValueObjects\Kanban\Position` (the fractional-indexing
...
final class ColumnController extends Controller
{
    ...
    public function destroy(Request $request, Project $project, Task $task, KanbanBoard $board, KanbanColumn $column): Response
    {
        ...
        // Belt-and-braces: a denial of KanbanColumnPolicy::delete is treated as
     ...
     * `KanbanBoard::whereHas('project', owner_id)` — same convention as the
