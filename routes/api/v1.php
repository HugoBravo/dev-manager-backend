...
Route::middleware(['auth:sanctum', 'throttle:api'])
    ...
    ->group(function (): void {
        ...
        Route::prefix('projects/{project}/tasks/{task}/kanban')->group(function (): void {
            Route::post('boards/reorder', [BoardController::class, 'reorder'])
                ->name('api.v1.projects.tasks.kanban.boards.reorder');
            ...
            Route::get('boards/trashed', [BoardController::class, 'trashed'])
                ->name('api.v1.projects.tasks.kanban.boards.trashed');

            Route::post('boards/{boardId}/restore', [BoardController::class, 'restore'])
                ->name('api.v1.projects.tasks.kanban.boards.restore');

            Route::apiResource('boards', BoardController::class)
                ->names([
                    'index' => 'api.v1.projects.tasks.kanban.boards.index',
                    'store' => 'api.v1.projects.tasks.kanban.boards.store',
                    'show' => 'api.v1.projects.tasks.kanban.boards.show',
                    'update' => 'api.v1.projects.tasks.kanban.boards.update',
                    'destroy' => 'api.v1.projects.tasks.kanban.boards.destroy',
                ]);

            Route::post('boards/{board}/archive', [BoardController::class, 'archive'])
                ->name('api.v1.projects.tasks.kanban.boards.archive');
            ...
            Route::post('boards/bulk-delete', [BoardBulkOperationsController::class, 'bulkDelete'])
                ->name('api.v1.projects.tasks.kanban.boards.bulk-delete');

            Route::post('boards/bulk-rename', [BoardBulkOperationsController::class, 'bulkRename'])
                ->name('api.v1.projects.tasks.kanban.boards.bulk-rename');
            ...
            Route::post('boards/{board}/clone', [BoardController::class, 'clone'])
                ->name('api.v1.projects.tasks.kanban.boards.clone');
            ...
            Route::get('boards/{board}/audit', [BoardController::class, 'audit'])
                ->name('api.v1.projects.tasks.kanban.boards.audit');
            ...
            Route::post('boards/{board}/columns/reorder', [ColumnController::class, 'reorder'])
                ->name('api.v1.projects.tasks.kanban.boards.columns.reorder');

            Route::apiResource('boards/{board}/columns', ColumnController::class)
                ->names([
                    'index' => 'api.v1.projects.tasks.kanban.boards.columns.index',
                    'store' => 'api.v1.projects.tasks.kanban.boards.columns.store',
                    'show' => 'api.v1.projects.tasks.kanban.boards.columns.show',
                    'update' => 'api.v1.projects.tasks.kanban.boards.columns.update',
                    'destroy' => 'api.v1.projects.tasks.kanban.boards.columns.destroy',
                ]);

            Route::post('boards/{board}/columns/{column}/move', [ColumnController::class, 'move'])
                ->name('api.v1.projects.tasks.kanban.boards.columns.move');
            ...
            Route::post('boards/{board}/columns/{column}/cards/reorder', [CardController::class, 'reorder'])
                ->name('api.v1.projects.tasks.kanban.boards.columns.cards.reorder');

            Route::apiResource('boards/{board}/columns/{column}/cards', CardController::class)
                ->names([
                    'index' => 'api.v1.projects.tasks.kanban.boards.columns.cards.index',
                    'store' => 'api.v1.projects.tasks.kanban.boards.columns.cards.store',
                    'show' => 'api.v1.projects.tasks.kanban.boards.columns.cards.show',
                    'update' => 'api.v1.projects.tasks.kanban.boards.columns.cards.update',
                    'destroy' => 'api.v1.projects.tasks.kanban.boards.columns.cards.destroy',
                ]);

            Route::post('boards/{board}/columns/{column}/cards/{card}/archive', [CardArchiveController::class, 'archive'])
                ->name('api.v1.projects.tasks.kanban.boards.columns.cards.archive');

            Route::post('boards/{board}/columns/{column}/cards/{card}/restore', [CardArchiveController::class, 'restore'])
                ->name('api.v1.projects.tasks.kanban.boards.columns.cards.restore');

            Route::post('boards/{board}/columns/{column}/cards/{card}/move', [CardMoveController::class, 'move'])
                ->name('api.v1.projects.tasks.kanban.boards.columns.cards.move');
            ...
            Route::put('boards/{board}/columns/{column}/cards/{card}/labels', [CardLabelController::class, 'sync'])
                ->name('api.v1.projects.tasks.kanban.boards.columns.cards.labels.sync');
            ...
            Route::apiResource('boards/{board}/columns/{column}/cards/{card}/comments', CommentController::class)
                ->names([
                    'index' => 'api.v1.projects.tasks.kanban.boards.columns.cards.comments.index',
                    'store' => 'api.v1.projects.tasks.kanban.boards.columns.cards.comments.store',
                    'show' => 'api.v1.projects.tasks.kanban.boards.columns.cards.comments.show',
                    'update' => 'api.v1.projects.tasks.kanban.boards.columns.cards.comments.update',
                    'destroy' => 'api.v1.projects.tasks.kanban.boards.columns.cards.comments.destroy',
                ]);
            ...
            Route::apiResource('boards/{board}/columns/{column}/cards/{card}/attachments', AttachmentController::class)
                ...
                ->names([
                    'index' => 'api.v1.projects.tasks.kanban.boards.columns.cards.attachments.index',
                    'store' => 'api.v1.projects.tasks.kanban.boards.columns.cards.attachments.store',
                    'destroy' => 'api.v1.projects.tasks.kanban.boards.columns.cards.attachments.destroy',
                ]);
        });
